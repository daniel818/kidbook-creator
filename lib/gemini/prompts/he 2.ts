...
{
    "title": "כותרת עברית של הספר",
    "backCoverBlurb": "סיכום קצר ומרתק בעברית של הסיפור לכריכה האחורית (מקסימום 2-3 משפטים)",
    "characterDescription": "תיאור פיזי מפורט בעברית של הדמות הראשית (אם לא סופק)",
    "pages": [
        {
            "pageNumber": 1,
            "text": "טקסט עברי של הסיפור לעמוד זה (שמור על קצר לילדים) - רק עברית",
            "imagePrompt": "תיאור מפורט בעברית של האיור לעמוד זה, המתאר רק את הסצנה והפעולה. אל תתאר את סגנון האמנות (למשל 'קריקטורה', 'צבעי מים') מכיוון שזה מטופל בנפרד. - רק עברית"
        },
        ...
    ]
}

שוב: השתמש אך ורק בשפה העברית בכל השדות. אסור להשתמש באנגלית!
`;
